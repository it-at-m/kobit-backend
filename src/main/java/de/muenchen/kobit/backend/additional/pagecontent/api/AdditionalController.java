...
public class AdditionalController {
    ...
    public ItemWrapper createTextItem(@PathVariable PageType pageType, @RequestBody TextItem textItem) {
        if (pageType == PageType.GLOSSARY || pageType == PageType.DOWNLOADS) {
            ...
            ItemWrapper itemWrapper = new ItemWrapper.ItemWrapperBuilder()
    ...
    public ItemWrapper updateTextItem(@PathVariable PageType pageType, @PathVariable UUID itemId, @RequestBody TextItem textItem) {
        if (pageType == PageType.GLOSSARY || pageType == PageType.DOWNLOADS) {
