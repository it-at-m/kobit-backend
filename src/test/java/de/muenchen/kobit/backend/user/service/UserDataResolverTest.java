...
public class UserDataResolverTest {
    ...
    @InjectMocks private UserDataResolver userDataResolver;
    ...
    public void testGetCurrentUser(UserInfoView userInfoView, String expectedDepartment)
        ...
        tokenAttributes.put(
                "resource_access", "{\"kobit\":{\"roles\":[\"ROLE_USER\",\"ROLE_ADMIN\"]}}");
